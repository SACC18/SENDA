...
import { CalendarIcon, ClockIcon, MapIcon, ArrowsRightLeftIcon } from '@heroicons/react/24/solid'
...
export default function Login() {
  ...
  // Inicializar Tema y Texto desde LocalStorage
    ...
    <div className="min-h-screen bg-base-200 flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="card lg:card-side bg-base-100 shadow-2xl border border-base-300 max-w-5xl w-full overflow-hidden">
        ...
        <figure className="w-full lg:w-1/2 relative min-h-[500px] hidden lg:block group">
          ...
          <div className="absolute bottom-1 left-0 w-full flex justify-center pointer-events-none z-50">
            <div className="badge border-none gap-2 py-5 px-6 bg-slate-800/90 text-white shadow-2xl backdrop-blur-sm animate-bounce">
